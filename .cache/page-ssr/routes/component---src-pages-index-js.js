...
function createProjectionNode({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform, }) {
    return class ProjectionNode {
        ...
        getProjectionStyles(styleProp) {
            ...
            styles.transform = (0,_styles_transform_mjs__WEBPACK_IMPORTED_MODULE_26__.buildProjectionTransform)(this.projectionDeltaWithTransform, this.treeScale, valuesToRender);
...
})(["font-size:clamp(26px,5vw,32px);color:", ";font-weight:700;margin-top:60px;text-align:center;"], ({
  theme
}) => theme.colors.white);
...
})(["max-width:700px;color:", ";font-size:16px;line-height:1.6;"], ({
  theme
...
})(["max-width:900px;margin:0 auto;padding:150px 0;display:flex;flex-direction:column;align-items:center;@media (max-width:768px){padding:100px 0;}"]);
const Title = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].h2.withConfig({
  displayName: "Contact__Title"
})(["width:100%;font-size:clamp(26px,5vw,32px);color:", ";font-weight:700;margin-bottom:40px;text-align:center;"], ({
  theme
}) => theme.colors.white);
...
const Section = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].section.withConfig({
  displayName: "Experience__Section"
...
const experiences = [{
  ...
  logo: "UAS-logo.png",
  details: ["Built a Power Automate flow to extract key content from internal HR docs and create AI-generated summary emails.", "Developed Copilot-powered scheduling assistant for staff across departments.", "Created secure RESTful APIs and integrated with Azure OAuth for secure document access.", "Led a six-person Agile team in weekly standups, sprint planning, and demos."]
}, {
  company: "Tractor Supply Company",
  role: "IT Intern",
  location: "Brentwood, TN",
  logo: "tractor_supply-logo.png",
  details: ["Built APIs using Java and Spring Boot to support inventory data workflows.", "Worked with SQL, Postman, and Eclipse for database integration and endpoint testing.", "Reduced manual entry through automation, increasing internal system speed and accuracy.", "Collaborated with a Scrum team on daily tickets and long-term sprints."]
}, {
  company: "Vacayzen",
  role: "IT Intern",
  location: "Grayton Beach, FL",
  logo: "Vacayzen-logo.png",
  details: ["Developed internal tools using C#, ASP.NET MVC, and JavaScript.", "Improved site responsiveness with jQuery, Vue.js, and Bootstrap.", "Maintained MongoDB records and contributed to Git version control workflows."]
}, {
...
})(["padding:150px 20px;text-align:center;color:", ";display:flex;flex-direction:column;align-items:center;justify-content:center;@media (max-width:768px){padding:100px 20px;}"], ({
  theme
}) => theme.colors.white);
...
})(["display:flex;justify-content:center;align-items:center;margin-bottom:1rem;img{height:140px;width:auto;@media (max-width:768px){height:100px;}@media (max-width:480px){height:80px;}}"]);
...
const Nav = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledHeader, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Logo, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: "/",
  "aria-label": "home"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
  src: "/logo.png",
  alt: "Michael Brogan Logo"
...
const Grid = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "Projects__Grid"
})(["display:grid;grid-template-columns:repeat(3,1fr);gap:20px;width:100%;justify-content:center;@media (max-width:1024px){grid-template-columns:repeat(2,1fr);}@media (max-width:600px){grid-template-columns:1fr;}"]);
const Card = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].a.withConfig({
  displayName: "Projects__Card"
})(["background-color:", ";padding:20px;border-radius:8px;color:inherit;text-decoration:none;transition:transform 0.3s ease;display:flex;flex-direction:column;align-items:center;text-align:center;&:hover{transform:translateY(-5px);}img{background:white;max-height:100px;width:auto;margin-bottom:20px;object-fit:contain;padding:10px;border-radius:4px;}h3{margin:0;font-size:18px;text-align:center;color:", ";}p{font-size:14px;color:", ";margin:8px 0 0;}"], ({
  theme
}) => theme.colors.lightNavy, ({
  theme
}) => theme.colors.white, ({
...
const projects = [{
  ...
  logo: "https://assets.softr-files.com/applications/df0789aa-54b4-4d20-b138-f8c96e79952b/assets/dde35ac7-42f8-4667-8179-ed4fe3b099e2.jpeg",
  url: "https://www.mckenziestrategies.com/"
}, {
  name: "Thigpen FlyFish",
  description: "Fishing Guide · SE, Louisiana",
  logo: "https://assets.softr-files.com/applications/0ffe45ff-98f7-45e9-9168-e620a9489559/assets/78a5cf83-936a-45b1-9aae-68c5f6660ff7.jpeg",
  url: "https://www.thigpenflyfishing.com"
}, {
  name: "Build Art",
  description: "Builder · Tuscaloosa, AL",
  logo: "https://assets.softr-files.com/applications/d896b043-47a5-4d37-8c4b-c3c30c5717e2/assets/331b8e4f-72e4-45fa-a6c1-0dc70f00c2df.png",
  url: "https://www.ttownhouse.com"
}, {
  name: "KA Alpha Beta",
  description: "Fraternity · Tuscaloosa, AL",
  logo: "https://assets.softr-files.com/applications/110d6191-43fd-407c-8a99-f5ea65c1b4e0/assets/e97fabde-2df1-4fce-9295-8c6ba6cf49eb.png",
  url: "https://www.kaalphabeta.com"
}, {
  name: "Berger Health",
  description: "Fitness · NO, Louisiana",
  logo: "https://assets.softr-files.com/applications/9a27a6c3-e4ff-49ca-96b9-f0e33072e73b/assets/91e6e5d1-8263-4992-a28e-80da4982aa18.png",
  url: "https://www.bergerhealth.org"
}, {
  name: "Untold Agency",
  description: "Media Agency · Miami, FL",
  logo: "https://assets.softr-files.com/applications/1a0d905f-0aa4-4cb1-92d8-849dc0353006/assets/608d6963-3f0c-46ce-b828-807a0a181252.jpeg",
  url: "https://www.theuntoldagency.com"
}, {
  name: "Creator Map",
  description: "Creator Platform · United States",
  logo: "https://assets.softr-files.com/applications/f337a486-9cbb-468b-b871-1a84332cea99/assets/d2cced6b-29b1-4201-9977-9173e7cc3790.png",
  url: "https://www.thecreatormap.com"
}, {
  name: "Seafarer Group",
  description: "Merch Group · Miami, FL",
  logo: "https://assets.softr-files.com/applications/d9167292-1fb8-4f1d-87db-c0d2f5a52ab3/assets/142cf2e2-6ff8-4a98-afab-b6bc62d399a3.png",
  url: "https://www.theseafarergroup.com"
}, {
  name: "All Around Movers Co",
  description: "Moving Company · Birmingham, AL",
  logo: "https://assets.softr-files.com/applications/db199dc6-b907-4b0e-b218-72ac2169e32e/assets/dd0e48fb-0d43-4b19-8cdf-7f2008a5102e.png",
...
const Projects = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Section, {
  id: "projects"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Title, null, "Projects"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Grid, null, projects.map((project, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Card, {
  key: index,
  href: project.url,
  target: "_blank",
  rel: "noopener noreferrer"
  ...
  src: project.logo,
  alt: project.name
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, project.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, project.description)))));
...
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Hero__WEBPACK_IMPORTED_MODULE_2__["default"], null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
  id: "about",
  style: {
    minHeight: "100vh",
    display: "flex",
...
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_About__WEBPACK_IMPORTED_MODULE_3__["default"], null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
  id: "experience",
  style: {
    minHeight: "100vh",
    display: "flex",
...
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Experience__WEBPACK_IMPORTED_MODULE_4__["default"], null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
  id: "projects",
  style: {
    minHeight: "100vh",
    display: "flex",
...
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Projects__WEBPACK_IMPORTED_MODULE_5__["default"], null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
  id: "contact",
  style: {
    minHeight: "100vh",
    display: "flex",
...
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Contact__WEBPACK_IMPORTED_MODULE_6__["default"], null)));
