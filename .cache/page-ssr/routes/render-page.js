...
// EXTERNAL MODULE: external "C:\\Personal-website\\node_modules\\react\\index.js"
var external_C_Personal_website_node_modules_react_index_js_ = __webpack_require__(1967);
var external_C_Personal_website_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Personal_website_node_modules_react_index_js_);
...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Personal_website_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_Personal_website_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_Personal_website_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Personal_website_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_Personal_website_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_Personal_website_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
;// ./.cache/slice.js
"use client";function Slice(props){if(true){// we use sliceName internally, so remap alias to sliceName
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Personal_website_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Personal_website_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Personal_website_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Personal_website_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
if((external_C_Personal_website_node_modules_react_index_js_default()).captureOwnerStack){// React 19+ approach
const ownerStack=external_C_Personal_website_node_modules_react_index_js_default().captureOwnerStack();const currentStack=new Error().stack||``;fullStack=ownerStack?`${currentStack}\n${ownerStack}`:currentStack;}else if((_React$__SECRET_INTER=(external_C_Personal_website_node_modules_react_index_js_default()).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED)!==null&&_React$__SECRET_INTER!==void 0&&(_React$__SECRET_INTER2=_React$__SECRET_INTER.ReactDebugCurrentFrame)!==null&&_React$__SECRET_INTER2!==void 0&&_React$__SECRET_INTER2.getCurrentStack){// React 18 approach
fullStack=external_C_Personal_website_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();}else{// Fallback if neither API is available
...
var _react = _interopRequireDefault(__webpack_require__(1967));
...
__webpack_require__.d(__webpack_exports__, {
  ...
  StyleSheetConsumer: () => (/* binding */ pt),
  StyleSheetContext: () => (/* binding */ ht),
  StyleSheetManager: () => (/* binding */ mt),
  ThemeConsumer: () => (/* binding */ yt),
  ThemeContext: () => (/* binding */ gt),
  ThemeProvider: () => (/* binding */ St),
  __PRIVATE__: () => (/* binding */ Ut),
  createGlobalStyle: () => (/* binding */ Mt),
  createTheme: () => (/* binding */ Ft),
  css: () => (/* binding */ Rt),
  "default": () => (/* binding */ kt),
  isStyledComponent: () => (/* binding */ le),
  keyframes: () => (/* binding */ Lt),
  styled: () => (/* binding */ kt),
  stylisPluginRSC: () => (/* binding */ tn),
  useTheme: () => (/* binding */ vt),
  version: () => (/* binding */ u),
  withTheme: () => (/* binding */ qt)
});
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1967);
...
var React = __webpack_require__(1967);
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var _react=_interopRequireDefault(__webpack_require__(1967));var _styledComponents=__webpack_require__(834);var sheetByPathname=new Map();// eslint-disable-next-line react/prop-types,react/display-name
...
var React = _interopRequireWildcard(__webpack_require__(1967));
...
"use strict";
module.exports = require("C:\\Personal-website\\.cache\\ssr-builtin-trackers\\fs");
...
var _react = __webpack_require__(1967);
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var React=_interopRequireWildcard(__webpack_require__(1967));var _gatsby=__webpack_require__(123);var _common=__webpack_require__(1854);var _getManifestPathname=_interopRequireDefault(__webpack_require__(4598));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 125).then(__webpack_require__.bind(__webpack_require__, 3331)),"component---src-pages-contact-page-js":()=>__webpack_require__.e(/* import() | component---src-pages-contact-page-js */ 935).then(__webpack_require__.bind(__webpack_require__, 9992)),"component---src-pages-index-js":()=>Promise.all(/* import() | component---src-pages-index-js */[__webpack_require__.e(60), __webpack_require__.e(293)]).then(__webpack_require__.bind(__webpack_require__, 8171))};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1967);
...
const isHeadRenderFromContext=external_C_Personal_website_node_modules_react_index_js_default().useContext(IsHeadRenderContext);return isHeadRenderFromContext;}function htmlOrBodyComponentFactory(TagName){const HeadAwareComponent=props=>{// De-risk monkey patch by only applying it within a `Head()` render.
...
const React=__webpack_require__(1967);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(3304);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(1041);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(6560),options:{"plugins":[]}},{name:'gatsby-plugin-styled-components',plugin:__webpack_require__(3203),options:{"plugins":[],"displayName":true,"fileName":true,"minify":true,"namespace":"","transpileTemplateLiterals":true,"topLevelImportPaths":[],"pure":false,"disableVendorPrefixes":false}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(4858),options:{"plugins":[],"name":"Michael Brogan Portfolio","short_name":"MBrogan","start_url":"/","background_color":"#0a192f","theme_color":"#0a192f","display":"minimal-ui","icon":"static/logo.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"4716d05115f77991670d80c4d03fa7b1"}},{name:'gatsby-plugin-image',plugin:__webpack_require__(70),options:{"plugins":[]}},{name:'gatsby-plugin-google-fonts',plugin:__webpack_require__(2901),options:{"plugins":[],"fonts":["Inter:400,700","Fira+Mono:400"],"display":"swap"}},{name:'default-site-plugin',plugin:__webpack_require__(8447),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/******/ 			return "" + ({"125":"component---src-pages-404-js","293":"component---src-pages-index-js","935":"component---src-pages-contact-page-js"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(1967);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(1041);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(3410);const{WritableAsPromise}=__webpack_require__(7227);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(8227);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
